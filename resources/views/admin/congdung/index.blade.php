            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('suaxuatxu', ['id'=>$value->cd_id]) }}" class="btn btn-primary">Sửa</a>
                  <a href="{{ route('suaxuatxu', ['id'=>$value->cd_id]) }}" class="btn btn-primary">Xóa</a>
                </td>
              </tr>
              @endforeach
          ...
          <div class="modal-body">
            <form method="POST" action="{{ route('themsanpham') }}">
              ...
              <div class="form-group">
                ...
                <input name="tenSP" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên công dụng . . . ">
              </div>
